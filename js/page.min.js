...
async function signUp(){let email=document.getElementById("sign-up-email").value.trim();let password=document.getElementById("sign-up-password").value;let confirmPassword=document.getElementById("sign-up-confirm-password").value;let genders="";let genderOps=document.getElementById("sign-up-gender").options;for(const op of genderOps){if(op.selected){genders=(genders==""?"":genders+",")+op.value.trim();}}
let data={githubAccount:document.getElementById("sign-up-github-account").value.trim(),jobTitle:document.getElementById("sign-up-job-title").value.trim(),company:document.getElementById("sign-up-company").value.trim(),country:document.getElementById("sign-up-country").value.trim(),genders:genders,genderDetails:document.getElementById("sign-up-gender-details").value.trim(),age:document.getElementById("sign-up-age").value.trim(),level:document.getElementById("sign-up-level").value.trim(),interest:document.getElementById("sign-up-interest").value.trim(),industry:document.getElementById("sign-up-industry").value.trim(),industryDetails:document.getElementById("sign-up-industry-details").value.trim(),}
if(email=="")
...
async function updateProfile(){let genders="";let genderOps=document.getElementById("profile-gender").options;for(const op of genderOps){if(op.selected){genders=(genders==""?"":genders+",")+op.value.trim();}}
let data={githubAccount:document.getElementById("profile-github-account").value.trim(),jobTitle:document.getElementById("profile-job-title").value.trim(),company:document.getElementById("profile-company").value.trim(),country:document.getElementById("profile-country").value.trim(),genders:genders,genderDetails:document.getElementById("profile-gender-details").value.trim(),age:document.getElementById("profile-age").value.trim(),level:document.getElementById("profile-level").value.trim(),interest:document.getElementById("profile-interest").value.trim(),industry:document.getElementById("profile-industry").value.trim(),industryDetails:document.getElementById("profile-industry-details").value.trim(),}
...
document.getElementById("profile-country").value=data.country;if(data.genderDetails)
document.getElementById("profile-gender-details").value=data.genderDetails;if(data.age)
...
document.getElementById("profile-industry-details").value=data.industryDetails;let genders=(data.genders||"").split(",");let genderOps=document.getElementById("profile-gender").options;for(const op of genderOps){if(genders.includes(op.value.trim()))
op.selected=true;}
{let let_me_type=document.getElementById("let-me-type-gender");let let_me_type_row=document.getElementById("let-me-type-gender-row");let_me_type_row.style.display=let_me_type.selected?"flex":"none";}
{let let_me_type=document.getElementById("let-me-type-industry");let let_me_type_row=document.getElementById("let-me-type-industry-row");let_me_type_row.style.display=let_me_type.selected?"flex":"none";}
